...
unless Presentacion.any?
  Presentacion.create(encuentro_id: 1, artista_id: 1)
  Presentacion.create(encuentro_id: 1, artista_id: 2)
  Presentacion.create(encuentro_id: 1, artista_id: 3)
  Presentacion.create(encuentro_id: 1, artista_id: 4)
  Presentacion.create(encuentro_id: 1, artista_id: 5)
  Presentacion.create(encuentro_id: 1, artista_id: 6)
  Presentacion.create(encuentro_id: 1, artista_id: 7)
end
